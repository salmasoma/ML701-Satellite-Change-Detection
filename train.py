...
# from models.SSCDe import SSCDe as Net
# from models.HRSCD4 import HRSCD4 as Net

NET_NAME = 'SSCDl'
DATA_NAME = 'Second Augmented SSCDl'
###############################################    
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            if args['gpu']:
                ...
                labels_bn = (labels_A>0).unsqueeze(1).to(device, dtype=torch.float32)
                labels_A = labels_A.to(device, dtype=torch.long)
                labels_B = labels_B.to(device, dtype=torch.long)
